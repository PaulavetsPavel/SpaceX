...
// код для определения тачскрин или мышь
const isMobile = {
  Android: function () {
...
// код для раскрытия подменю при нажатии на стрелочку в меню
if (isMobile.any()) {
